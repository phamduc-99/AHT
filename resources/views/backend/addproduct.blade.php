                                   ...
                                   @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar1" class="thumbnail" width="25%" height="150px" src="img/import-img.png">                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Ảnh sản phẩm 2</label>
                                            <input id="img2" type="file" name="img2" class="form-control hidden"
                                                onchange="changeImg2(this)">
                                            <img id="avatar2" class="thumbnail" width="25%" height="150px" src="img/import-img.png">                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Ảnh sản phẩm 3</label>
                                            <input id="img3" type="file" name="img3" class="form-control hidden"
                                                onchange="changeImg3(this)">
                                            <img id="avatar3" class="thumbnail" width="25%" height="150px" src="img/import-img.png">                                           
                                        </div>
