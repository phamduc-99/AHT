                        ...
                        <div class="bootstrap-table">
                            <div class="table-responsive">
                                            ...
                                            <div class="panel panel-blue">
                                                ...
                                                <div class="panel-body">
                                                    <strong><span class="glyphicon glyphicon-user"
                                                            aria-hidden="true"></span> : {{$order->user()->first()->fullname}}</strong> <br>
                                                    <strong><span class="glyphicon glyphicon-phone"
                                                            aria-hidden="true"></span> : {{$order->user()->first()->phone}}</strong>
                                                    <br>
                                                    <strong><span class="glyphicon glyphicon-send"
                                                            aria-hidden="true"></span> : {{$order->user()->first()->address}}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img width="100px" src="../image/{{ $detail->image}}" class="thumbnail">
                                                    </div>
                                                    <div class="col-md-8">
                                ...
                                <div class="alert alert-primary" role="alert" align='right'>
                                    <a name="" id="" class="btn btn-success" href="{{route('order.approve',['id'=>$order->id])}}" role="button">Giao hàng thành công</a>
                                </div>
                            </div>
                        </div>
