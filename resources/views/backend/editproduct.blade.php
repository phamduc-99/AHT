                        ...
                        <div class="row" style="margin-bottom:40px">
                                 ...
                                 <div class="col-md-8">                                       
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select name="featured" class="form-control">
                                             ...
                                             <option @if($product->featured == 1) selected @endif value="1">Hot</option>
                                             <option @if($product->featured == 2) selected @endif value="2">New</option>
                                         </select>
                                     </div>
                                     <div class="form-group">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input @foreach($product->category as $key=>$ca) @if($ca->name == $category->name) checked="checked" @endif  @endforeach type="checkbox"  name="category[]" value="{{$category->id}}"> {{$category->name}}
                                         &nbsp
                                         @endforeach
                                     </div>
                         ...
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="form-group">
                                     <label>Miêu tả</label>
                                     <textarea id="editor" name="describe" style="width: 100%;height: 100px;">{{$product->describer}}</textarea>
                                 </div>
